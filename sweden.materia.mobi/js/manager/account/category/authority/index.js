var aRandomCode = 'AccountCategoryAuthority';
var columns = [];
columns.push({
    field: 'id',
    title: 'ID',
...
function loadData(){
    Ding.ajax({
        'url' : projectName+"/manager/data/list.shtml?aRandomCode="+aRandomCode,
...
function initConfig(id){
    this.location = projectName+"/manager/account/category/authority/initConfigLinkAuthority.shtml?id="+id;
}
