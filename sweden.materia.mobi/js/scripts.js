...
(function() {
    ...
    // grab an element
    var myElement = document.getElementById("mHeadRoom");
   ...
   jQuery('.toggle-btn').click(function(){
      ...
      if(bodyposition != 'relative') {
         if(!body.hasClass('left-side-collapsed')) {
            $.cookie('menu-collapsed', 'close',{ expires: 30 }); 
            ...
            $.cookie('menu-collapsed','open',{ expires: 30 }); 
    ...
    if($.cookie('menu-collapsed')=="close"){
